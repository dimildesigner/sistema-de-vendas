from conexao import Conexao  # Ajuste o nome do arquivo se necessÃ¡rio

class CategoriaRepository:
    def __init__(self):
        self.conexao = Conexao()  # Armazena instÃ¢ncia completa da Conexao

    def find_all(self):
            cursor = self.conexao.get_cursor()  # dictionary=True jÃ¡ configurado
    ...
    def fechar_conexao(self):
        """Fecha conexÃ£o do repositÃ³rio."""
