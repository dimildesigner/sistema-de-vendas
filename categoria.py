class Categoria:
    ...
    def nome(self, valor):
        if isinstance(valor, str) and len(valor.strip()) > 0 and len(valor) <= 100:
            ...
            raise ValueError("Nome deve ser string nÃ£o vazia (mÃ¡x. 100 caracteres)")

    # Getter e Setter para DescriÃ§Ã£o
    @property
    def descricao(self):
    ...
    def descricao(self, valor):
        if isinstance(valor, str) and len(valor) <= 500:
            ...
            raise ValueError("DescriÃ§Ã£o deve ser string (mÃ¡x. 500 caracteres)")
...
#             self.__nome = valor.strip()
#         else:
#             raise ValueError("Nome deve ser string nÃƒÂ£o vazia (mÃƒÂ¡x. 100 caracteres)")

#     # Getter e Setter para DescriÃƒÂ§ÃƒÂ£o
#     @property
#     def descricao(self):
#         return self.__descricao
...
#             self.__descricao = valor.strip()
#         else:
#             raise ValueError("DescriÃƒÂ§ÃƒÂ£o deve ser string (mÃƒÂ¡x. 500 caracteres)")
